	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">Historical Artifacts Tracker</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className=''>
				<input type='text' className='border px-6 py-2 rounded-md shadow-lg' placeholder='Enter your emali '/>
				<button className='px-8 border py-1 bg-blue-700 mt-2 rounded'>Send</button>
			</div>
