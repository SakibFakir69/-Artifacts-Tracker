...
function Footer() {
  return (
    <div className="mt-10">
      ...
      <footer className="bg-stone-950 shadow-md rounded-xl w-full p-3 md:p-4 relative">
        <div className="w-full flex items-center justify-center pt-[30px] flex-col gap-[20px] pb-[130px]">

			<div>
				<h2 className="text-4xl font-semibold text-white">Artifact Tracker</h2>
			</div>
        
          <p className="text-[0.9rem] text-center sm:text-start text-slate-300">
          ...
          <div className="flex gap-[15px] text-black mt-4">
            ...
            <a href="https://www.linkedin.com/in/sakib-fakir-183923295/" className="text-[1.2rem] p-1.5 cursor-pointer rounded-full bg-white text-[#424242] shadow-md">
              <BsLinkedin />
            </a>
          </div>
        </div>
